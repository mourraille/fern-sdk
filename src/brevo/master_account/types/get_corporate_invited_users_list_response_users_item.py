...
class GetCorporateInvitedUsersListResponseUsersItem(UniversalBaseModel):
    ...
    feature_access: GetCorporateInvitedUsersListResponseUsersItemFeatureAccess = pydantic.Field()
    """
    Feature accessiblity given to the user. (Required only
    if status is active)
    """

    groups: GetCorporateInvitedUsersListResponseUsersItemGroups = pydantic.Field()
    """
