...
class InviteAdminUserRequestPrivilegesItem(UniversalBaseModel):
    ...
    feature: typing.Optional[InviteAdminUserRequestPrivilegesItemFeature] = pydantic.Field(default=None)
    """
    Feature name
    """

    permissions: typing.Optional[typing.List[InviteAdminUserRequestPrivilegesItemPermissionsItem]] = pydantic.Field(
        default=None
    )
    """
