...
class GetEmailCampaignsResponseCampaignsItem(UniversalBaseModel):
    ...
    status: GetEmailCampaignsResponseCampaignsItemStatus = pydantic.Field()
    """
    ...
    type: GetEmailCampaignsResponseCampaignsItemType = pydantic.Field()
    """
    Type of campaign
    """
    ...
    sender: GetEmailCampaignsResponseCampaignsItemSender
