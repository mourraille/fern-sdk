...
export declare namespace BrevoApiClient {
...
export class BrevoApiClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<BrevoApiClient.Options>;
    ...
    constructor(options: BrevoApiClient.Options) {
