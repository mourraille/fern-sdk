...
export class CustomObjectsClient {
     ...
     *
     * @param {BrevoApi.UpsertrecordsRequest} request
    ...
    ): core.HttpResponsePromise<BrevoApi.UpsertrecordsResponse> {
    ...
    private async __upsertrecords(
        request: BrevoApi.UpsertrecordsRequest,
        requestOptions?: CustomObjectsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.UpsertrecordsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.UpsertrecordsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.GetrecordsRequest} request
     * @param {CustomObjectsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.ForbiddenError}
    ...
    public getrecords(
        ...
        requestOptions?: CustomObjectsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.GetrecordsResponse> {
    ...
    private async __getrecords(
        request: BrevoApi.GetrecordsRequest,
        requestOptions?: CustomObjectsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetrecordsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetrecordsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.BatchDeleteObjectRecordsRequest} request
     * @param {CustomObjectsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.ForbiddenError}
    ...
    public batchDeleteObjectRecords(
        ...
        requestOptions?: CustomObjectsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.BatchDeleteObjectRecordsResponse> {
    ...
    private async __batchDeleteObjectRecords(
        request: BrevoApi.BatchDeleteObjectRecordsRequest,
        requestOptions?: CustomObjectsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.BatchDeleteObjectRecordsResponse>> {
        const { object_type: objectType, ..._body } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as BrevoApi.BatchDeleteObjectRecordsResponse,
                rawResponse: _response.rawResponse,
            };
        }
