...
export class AccountClient {
    ...
    ): core.HttpResponsePromise<BrevoApi.GetAccountResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAccount(requestOptions));
    }

    private async __getAccount(
        requestOptions?: AccountClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetAccountResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetAccountResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.GetAccountActivityRequest} request
     * @param {AccountClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public getAccountActivity(
        ...
        requestOptions?: AccountClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.GetAccountActivityResponse> {
    ...
    private async __getAccountActivity(
        request: BrevoApi.GetAccountActivityRequest = {},
        requestOptions?: AccountClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetAccountActivityResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetAccountActivityResponse, rawResponse: _response.rawResponse };
        }
