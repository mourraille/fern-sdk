...
export class ExternalFeedsClient {
     ...
     *
     * @param {BrevoApi.GetAllExternalFeedsRequest} request
    ...
    ): core.HttpResponsePromise<BrevoApi.GetAllExternalFeedsResponse> {
    ...
    private async __getAllExternalFeeds(
        request: BrevoApi.GetAllExternalFeedsRequest = {},
        requestOptions?: ExternalFeedsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetAllExternalFeedsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetAllExternalFeedsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.CreateExternalFeedRequest} request
     * @param {ExternalFeedsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     *
    ...
    public createExternalFeed(
        ...
        requestOptions?: ExternalFeedsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.CreateExternalFeedResponse> {
    ...
    private async __createExternalFeed(
        request: BrevoApi.CreateExternalFeedRequest,
        requestOptions?: ExternalFeedsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.CreateExternalFeedResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.CreateExternalFeedResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.GetExternalFeedByUuidRequest} request
     * @param {ExternalFeedsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.NotFoundError}
    ...
    public getExternalFeedByUuid(
        ...
        requestOptions?: ExternalFeedsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.GetExternalFeedByUuidResponse> {
    ...
    private async __getExternalFeedByUuid(
        request: BrevoApi.GetExternalFeedByUuidRequest,
        requestOptions?: ExternalFeedsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetExternalFeedByUuidResponse>> {
        const { uuid } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as BrevoApi.GetExternalFeedByUuidResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {BrevoApi.UpdateExternalFeedRequest} request
     * @param {ExternalFeedsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.NotFoundError}
     ...
     *
     * @param {BrevoApi.DeleteExternalFeedRequest} request
     * @param {ExternalFeedsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.NotFoundError}
