...
export class ProcessClient {
     ...
     *
     * @param {BrevoApi.GetProcessesRequest} request
    ...
    ): core.HttpResponsePromise<BrevoApi.GetProcessesResponse> {
    ...
    private async __getProcesses(
        request: BrevoApi.GetProcessesRequest = {},
        requestOptions?: ProcessClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetProcessesResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetProcessesResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.GetProcessRequest} request
     * @param {ProcessClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
    ...
    public getProcess(
        ...
        requestOptions?: ProcessClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.GetProcessResponse> {
    ...
    private async __getProcess(
        request: BrevoApi.GetProcessRequest,
        requestOptions?: ProcessClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetProcessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetProcessResponse, rawResponse: _response.rawResponse };
        }
