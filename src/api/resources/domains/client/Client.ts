...
export class DomainsClient {
    ...
    ): core.HttpResponsePromise<BrevoApi.GetDomainsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getDomains(requestOptions));
    }

    private async __getDomains(
        requestOptions?: DomainsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetDomainsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.GetDomainsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.CreateDomainRequest} request
     * @param {DomainsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     *
    ...
    public createDomain(
        ...
        requestOptions?: DomainsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.CreateDomainResponse> {
    ...
    private async __createDomain(
        request: BrevoApi.CreateDomainRequest,
        requestOptions?: DomainsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.CreateDomainResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.CreateDomainResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {BrevoApi.GetDomainConfigurationRequest} request
     * @param {DomainsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
    ...
    public getDomainConfiguration(
        ...
        requestOptions?: DomainsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.GetDomainConfigurationResponse> {
    ...
    private async __getDomainConfiguration(
        request: BrevoApi.GetDomainConfigurationRequest,
        requestOptions?: DomainsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.GetDomainConfigurationResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as BrevoApi.GetDomainConfigurationResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {BrevoApi.DeleteDomainRequest} request
     * @param {DomainsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.NotFoundError}
     ...
     *
     * @param {BrevoApi.AuthenticateDomainRequest} request
     * @param {DomainsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BrevoApi.BadRequestError}
     * @throws {@link BrevoApi.NotFoundError}
    ...
    public authenticateDomain(
        ...
        requestOptions?: DomainsClient.RequestOptions,
    ): core.HttpResponsePromise<BrevoApi.AuthenticateDomainResponse> {
    ...
    private async __authenticateDomain(
        request: BrevoApi.AuthenticateDomainRequest,
        requestOptions?: DomainsClient.RequestOptions,
    ): Promise<core.WithRawResponse<BrevoApi.AuthenticateDomainResponse>> {
        const { domainName } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as BrevoApi.AuthenticateDomainResponse, rawResponse: _response.rawResponse };
        }
